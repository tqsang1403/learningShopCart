...
export class InvoiceService {
  ...
  private urlInvoice_detail =
    'https://633150d9cff0e7bf70ea4775.mockapi.io/api/invoice_detail';
  ...
  getInvoice_Detail(id: number) {
    return this.http.get<any>(this.urlInvoice_detail + '/' + id).pipe(
      tap((res: any) => {
  ...
  getInvoice_Detail_List() {
    return this.http.get<any>(this.urlInvoice_detail).pipe(
      tap((res: any) => {
        this.invoice_detail_list = res;
      })
    );
